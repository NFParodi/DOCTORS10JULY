...
return  (  
    ...
    <div>
        <input className="busqueda" placeholder="Ingrese especialidad" type="text" value = {palabrabusqueda} onChange={(e)=>setpalabrabusqueda(e.target.value)} />  {/*para manejar el submit, que no se ejecute, hago una funcion aparte "hanlde"*/}
    </div>
...
<Singout/>
    ...
    //     </div>
    //     <div>
    //         <label>Ingrese nombre o especialidad o ciudad:</label>
    //         <input type="text" value = {palabrabusqueda} onChange={(e)=>setpalabrabusqueda(e.target.value)} />  {/*para manejar el submit, que no se ejecute, hago una funcion aparte "hanlde"*/}
    //     </div>
